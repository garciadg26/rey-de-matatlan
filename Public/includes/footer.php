         ...
         <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <img src="Public/images/vector_rey_de_matatlan_bn.svg" alt="">
                </div>
            </div>
            <!-- MENÙ FOOTER -->
            <div class="row">
            ...
            <div class="row">
                <div class="cont_social">
                    ...
                    <ul class="social_pago">
                        <li class="item_pago">
                            <img src="Public/images/icon_visa.svg" alt="">
                        </li>
                        <li class="item_pago">
                            <img src="Public/images/icon_mastercard.svg" alt="">
                        </li>
                        <li class="item_pago">
                            <img src="Public/images/icon_paypal.svg" alt="">
                        </li>
                    </ul>
                </div>
            </div>
            <!-- LEGALES -->
            <div class="row legales text-center">
                <div class="col-md-12">
                    <p> &reg; 2023 Derechos Reservados <a class="aviso_p" href="aviso-privacidad.php">AVISO DE PRIVACIDAD</a></p>
                </div>
            </div>
         </div>
    </footer>
