...
<div style="width:100%; padding:10px 0; display:table;">
    ...
    <div style="width:62%; padding:30px 1%; min-height:200px; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #996633;">
    	<?php
			...
			mysqli_query($conexion, "delete from hb_imagenes where id_imagen=$imagen");
				echo '<div id="mensaje">Información eliminada correctamente<br><br><a href="agregar_imagenes.php?hotel='.$hotel.'"><img src="../imagenes/icon_ok.png"></a></div>';
