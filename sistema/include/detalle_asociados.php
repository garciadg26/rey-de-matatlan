...
<div style="width:100%; padding:10px 0; display:table;">
    ...
    <div style="width:72%; padding:30px 1%; min-height:200px; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #0071BC;">
    	<?php
			...
			// LISTADO
			echo '<div id="mensaje">INFORMACIÓN ENVIADA</div>';
			echo '<div id="mitad_1">';
		...
		?>
        <div id="btn_cerrar">
        	<a href="../menu.php?opcion=asociados" target="_parent">CERRAR VENTANA</a>&nbsp;&nbsp;&nbsp;
            <?php
            	if($pasado!='si'){
					echo '<a href="confirmar.php?asociado='.$asociado.'" style="background:#FF9326; color:#333;">CONFIRMAR PROSPECTO</a>';
				}
			?>
        </div>
    </div>
