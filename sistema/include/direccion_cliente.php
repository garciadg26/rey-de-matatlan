    ...
    <div style="width:72%; padding:30px 1%; min-height:200px; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #0071BC;">
    	<?php
			...
			if($bandera==1){
				...
				mysqli_query($conexion, "update imn_clientes set calle='$calle', numero='$numero', colonia='$colonia', cp='$cp', ciudad='$ciudad', estado='$estado' where id_cliente=$cliente");
				...
				$sql = "select calle, numero, colonia, cp, ciudad, estado from imn_clientes where id_cliente=$cliente";
    	...
    	<form method="post" action="direccion_cliente.php?cliente=<?php echo $cliente; ?>" enctype="multipart/form-data">
