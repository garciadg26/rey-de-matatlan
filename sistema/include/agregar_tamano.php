    ...
    <div style="width:62%; padding:30px 1%; min-height:200px; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #273746;">
    	<?php
			...
			if($bandera==1){
				...
				mysqli_query($conexion, "insert into vin_tamanos(tamano, peso, fecha) values('$titulo', '$peso', '$fecha')");
		...
		?>
    	<form method="post" action="agregar_tamano.php" enctype="multipart/form-data">
        	<input type="hidden" name="bandera" value="1" />
						...
						<input type="text" name="titulo" id="titulo" class="texto" placeholder="* Título del tamaño" required/>
						<div class="clearer" style="height:5px"></div>
						<input type="text" name="peso" id="peso" class="texto" placeholder="* Peso de la botella" required/>
