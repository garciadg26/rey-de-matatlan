    ...
    <div style="width:72%; padding:30px 1%; min-height:200px; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #0071BC;">
    	<?php
			...
			if($bandera==1){
				...
				mysqli_query($conexion, "update imn_estudios set titulo_estudio='$titulo', informacion='$informacion', fecha='$fecha', activo='$activo', costo='$costo' where id_estudio=$estudio");
				...
				$sql = "select titulo_estudio, informacion, imagen, activo, costo from imn_estudios where id_estudio=$estudio";
    	...
    	<form method="post" action="modificar_estudio.php?estudio=<?php echo $estudio;?>" enctype="multipart/form-data">
            ...
            <div class="clearer" style="height:5px"></div>
            <input type="text" name="costo" id="costo" placeholder="* Costo del Estudio" class="texto" required="required" style="width:30%" value="<?php echo $costo; ?>"/>
            <div class="clearer" style="height:5px"></div>
