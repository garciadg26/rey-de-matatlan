...
<div style="width:100%; padding:10px 0; display:table;">
    ...
    <div style="width:62%; padding:30px 1%; min-height:200px; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #273746;">
				...
				if ($archivo != NULL)
					{
						...
						mysqli_query($conexion, "update mot_inicio set slide='$archivo' where id_imagen=$imagen");
				}

				mysqli_query($conexion, "update mot_inicio set titulo='$titulo', subtitulo='$subtitulo', visible='$visible', fecha='$fecha' where id_imagen=$imagen");
				echo '<div id="mensaje">Información actualizada correctamente<br><br><a href="../menu.php?opcion=slides" target="_parent"><img src="../imagenes/icon_ok.png"></a></div>';
			} else {
		...
		?>
    	<form method="post" action="modificar_inicio.php?imagen=<?php echo $imagen; ?>" enctype="multipart/form-data">
