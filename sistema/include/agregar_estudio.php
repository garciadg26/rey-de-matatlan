    ...
    <div style="width:72%; padding:30px 1%; min-height:200px; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #0071BC;">
    	<?php
			...
			if($bandera==1){
				...
				mysqli_query($conexion, "insert into imn_estudios(imagen, titulo_estudio, informacion, costo, fecha, activo) values('$archivo', '$titulo', '$informacion', '$precio', '$fecha', 'si')");
				echo '<div id="mensaje">Información registrada correctamente<br><br><a href="../menu.php?opcion=estudios" target="_parent"><img src="../imagenes/icon_ok.png"></a></div>';
			} else {
		?>
    	<form method="post" action="agregar_estudio.php" enctype="multipart/form-data">
        	<input type="hidden" name="bandera" value="1" />
            <input type="text" name="titulo" id="titulo" placeholder="* Nombre del Estudio" class="texto" required="required" />
            <div class="clearer" style="height:5px"></div>
            <input type="text" name="precio" id="precio" placeholder="* Precio del Estudio" class="texto" required="required" style="width:30%" />
            <div class="clearer" style="height:5px"></div>
