    ...
    <div style="width:62%; padding:30px 1%; min-height:200px; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #273746;">
    	<?php
			...
			if($bandera==1){
				...
				mysqli_query($conexion, "insert into mot_eventos(titulo, imagen, fecha, visible) values('$titulo', '$archivo', '$fecha', 'si')");
				echo '<div id="mensaje">Información registrada correctamente<br><br><a href="../menu.php?opcion=eventos" target="_parent"><img src="../imagenes/icon_ok.png"></a></div>';
			} else {
		?>
    	<form method="post" action="agregar_evento.php" enctype="multipart/form-data">
        	<input type="hidden" name="bandera" value="1" />
            <input type="text" name="titulo" id="titulo" placeholder="* Título del evento" class="texto" required="required" />
