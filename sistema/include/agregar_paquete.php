    ...
    <div style="width:62%; padding:30px 1%; min-height:200px; left:34%; position:absolute; margin-left:1px; float:left; background:rgba(51,51,51,0.1); border-left:solid 2px #273746;">
    	<?php
			...
			if($bandera==1){
				...
				mysqli_query($conexion, "insert into vin_paquetes(nombre, descripcion, precio, fecha, visible) values('$nombre', '$descripcion', '$precio', '$fecha', 'si')");
		...
		?>
    	<form method="post" action="agregar_paquete.php" enctype="multipart/form-data">
        	<input type="hidden" name="bandera" value="1" />
            <input type="text" name="nombre" id="nombre" placeholder="* Nombre del paquete" class="combo" required="required" style="width:42%; float:left;" />
            <div class="clearer" style="height:5px"></div>
            <input type="text" name="descripcion" id="descripcion" placeholder="* Breve descripción" class="texto" required="required" />
            <div class="clearer" style="height:5px"></div>
            <input type="text" name="precio" id="precio" placeholder="* Precio del paquete" class="texto" required="required" />
